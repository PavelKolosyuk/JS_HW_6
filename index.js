...
class Hamburger {
    ...
    removeTopping(topping) {
        if(this._toppings.includes(topping)){
            return this._toppings = this._toppings.filter(top => top === topping);
        };
    }
    ...
    calculateCalories() {
        ...
        let caloriesStuffing = Hamburger.STUFFINGS[this._stuffing].calories;
        let caloriesToppings = this._toppings.reduce((acc, el) => Hamburger.TOPPINGS[el].calories + acc, 0);
        return  caloriesSize + caloriesStuffing + caloriesToppings;
    }
}
